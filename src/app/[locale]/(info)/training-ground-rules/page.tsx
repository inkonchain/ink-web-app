...
export default function TrainingGroundRules() {
  return (
    <>
      ...
      <div>
        Employees, ofﬁcers, directors, managers, agents, consultants,
        ...
        corporate partners, divisions, subsidiaries, afﬁliates, successors in
        interest, advertising, promotion, and public relations agencies
        (collectively, the &quot;Competition Entities&quot;) are not eligible.
        For the purposes of the Competition, family members are deﬁned as
      ...
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>is libelous, defamatory, disparaging or tortious;</li>
        <li>is sexually-explicit;</li>
        <li>
          refers to or promotes lotteries or gambling, other competitions or
          giveaways, or other promotions;
        </li>
        <li>includes explicit or offensive language;</li>
        <li>advocates violence;</li>
        <li>advocates illegal activities;</li>
        <li>advocates tobacco, alcohol or drugs;</li>
        <li>
      ...
      <div>
        Winners will be notiﬁed via direct message from the official Ink social
      ...
      <div>
        ...
        Competition may be used by Ink and shared with Ink&apos;s afﬁliated
      ...
      <div>
        ...
        notiﬁcation or permission, except where prohibited by law, and you
      ...
      <div>
        ...
        earthquake, war, ﬁre, flood, epidemic, explosion, unusually severe
        ...
        authority, or any other cause, whether or not speciﬁcally mentioned
        above.
      </div>
      ...
      <ColoredText variant="purple" className="text-2xl">
