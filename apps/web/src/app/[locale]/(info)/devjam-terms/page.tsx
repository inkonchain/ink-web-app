...
export const metadata: Metadata = {
  title: "DevJam Terms of Attendance - Ink",
  description:
    "Terms and conditions for attending Ink DevJam: Building the Future of Defi – Bangkok 2024. Read our attendance policy, requirements, and other important information for event participants.",
};

export default function DevJamTerms() {
  return (
    <>
      <div className="flex flex-col gap-16 mb-24">
        <div className={containerClasses()}>
          ...
          <div>
            These are the terms of attendance (the &ldquo;Terms of
            Attendance&rdquo;) governing your application, attendance at and
            participation in Ink DevJam: Building the Future of Defi – Bangkok
            2024 (the &ldquo;Event&rdquo;).{" "}
            <b>
              By applying for, attending, or speaking at the Event you agree to
              these terms
            </b>
            , which form a legally binding contract between Ink Limited
            (&ldquo;us&rdquo; or &ldquo;Organizer&rdquo;) and you as the
            applicant, attendee, or speaker (&ldquo;you&rdquo; or
            &ldquo;Attendee&rdquo;).
          </div>
          ...
          <div>
            <b>1.1. Application.</b> Your application does not entitle you to
          ...
          <div>
            <b>1.2. Event Content.</b> You acknowledge and agree that the
          ...
          <div>
            <b>1.3. Identification.</b> All Attendees must provide an acceptable
            form of identification upon request: government-issued photo ID,
            passport, or other photo ID.
          </div>
          <div>
            <b>1.4. Denial of Admission.</b> The Organizer reserves the right to
          ...
          <div>
            <b>3.1. Use of Likeness.</b> By attending the Event you acknowledge
          ...
          <div>
            <b>3.2. No Right to Event Content.</b> With the exception of any
          ...
          <div>
            <b>3.3. Collection and Use of Data.</b> By applying for the Event
          ...
          <div>
            <b>4.1. General Rules.</b> You must comply with all applicable laws,
          ...
          <div>
            <b>4.2. Commercial Actions by Attendees.</b> Any and all commercial
          ...
          <div>
            <b>4.3. Disruptive Conduct.</b> You acknowledge and agree that
          ...
          <div>
            <b>4.4. Photography, Recording, Live Streaming, and Videotaping.</b>{" "}
          ...
          <div>
            <b>4.5. No Disparagement.</b> Attendee agrees not to disparage or
          ...
          <div>
            <b>5.1. Limitation of Liability.</b> Organizer is responsible for
          ...
          <div>
            <b>5.2. Indemnification.</b> By registering for the Event, Attendee
          ...
          <div>
            <b>6.1. Agreement | Changes to the Terms of Attendance.</b> The
          ...
          <div>
            <b>6.2. Governing Law & Jurisdiction.</b> These Terms of Attendance
